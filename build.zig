...
const samples_windows_linux = struct {
    ...
    pub const virtual_reality_d3d12 = @import("samples/virtual_reality_d3d12/build.zig");
...
fn tests(
    ...
    try @import("zopenvr").install_OpenVR(&openvr_tests.step, target.result, .bin, "libs/zopenvr");
